...
function module.Read(File)
    if isfile(game.GameId.."/"..File..".json") then
        return HttpService:JSONDecode(readfile(game.GameId.."/"..File..".json"))
    else
...
function module.Write(File, Data)
    ...
    writefile(game.GameId.."/"..File..".json",HttpService:JSONEncode(Data))
end

function module.Append(File, Data)
    if isfile(game.GameId.."/"..File..".json") then
        appendfile(game.GameId.."/"..File..".json",HttpService:JSONEncode(Data))
    else
